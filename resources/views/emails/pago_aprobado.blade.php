...
<body class="bg-gray-100 text-gray-900 font-sans">
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden mt-12">
        <div class="bg-indigo-600 p-6">
            <h1 class="text-2xl text-white font-bold">¡Pago Confirmado!</h1>
        </div>

        <div class="p-6">
            <p class="text-lg mb-4">Hola, <strong>{{ $payment['results'][0]['card']['cardholder']['name'] }}</strong></p>
            <p class="text-base mb-6">Tu pago se ha procesado exitosamente. Aquí están los detalles de tu actividad:</p>
            ...
            <p class="text-lg mb-6">Tus datos:</p>
            <ul class="space-y-3 mb-6">
                <li class="text-gray-700 font-semibold">Nombre y Apellido: <span class="font-normal">{{ $payment['results'][0]['card']['cardholder']['name'] }}</span></li>
                <li class="text-gray-700 font-semibold">DNI: <span class="font-normal">{{ $payment['results'][0]['payer']['identification']['number']  }}</span></li>
                <li class="text-gray-700 font-semibold">Email: <span class="font-normal">{{ $payment['results'][0]['payer']['email'] }}</span></li>
            </ul>

            <p class="text-base mb-6">Te esperamos puntualmente para disfrutar de la experiencia. ¡No olvides llevar lo necesario!</p>
        </div>
