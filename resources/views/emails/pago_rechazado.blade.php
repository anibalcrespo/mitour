...
<body class="bg-gray-100 text-gray-900 font-sans">
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden mt-12">
        <div class="bg-indigo-600 p-6">
            <h1 class="text-2xl text-white font-bold">¡Pago Rechazado!</h1>
        </div>

        <div class="p-6">
            <p class="text-lg mb-4">Hola, <strong>{{ $payment['results'][0]['card']['cardholder']['name'] }}</strong></p>
            <p class="text-base mb-6">Lamentablemente no pudimos procesar el pago de tu tour:</p>
            ...
            <div class="bg-indigo-50 p-4 rounded-lg shadow-sm mb-6">
                <ul class="space-y-3">
                    ...
                    <li class="text-gray-700 font-semibold">Hora Inicio: <span class="font-normal">{{ $instancia->_inicio }}</span></li>
            ...
            <div class="bg-indigo-50 p-4 rounded-lg shadow-sm mb-6">
            <strong>Motivo:</strong> Pago Rechazado<br>
            <br>
            <p>Podés intentar realizar el pago nuevamente y si tenes dudas escribinos a soporte@mitour.com.ar</p>
            </div>
