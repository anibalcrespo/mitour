...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('actividades.store') }}" method="POST" class="mt-6" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="titulo" id="titulo" class="w-full px-4 py-2 border rounded" value="{{ old('titulo') }}" required>
                @error('titulo')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="descripcion" id="descripcion" rows="10" class="ckeditor w-full px-4 py-2 border rounded">{!! old('descripcion') !!}</textarea>
                @error('descripcion')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image1" id="image1" class="hidden" value="{{ old('image1') }}" required>
                @error('image1')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image2" id="image2" class="hidden" value="{{ old('image2') }}">
                @error('image2')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image3" id="image3" class="hidden" value="{{ old('image3') }}">
                @error('image3')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
